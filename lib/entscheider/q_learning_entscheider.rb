...
require_relative 'q_learning_entscheider/ai_input_ersteller'
require_relative 'gemeinsam/spiel_informations_sicht_benutzender'
require_relative 'zufalls_entscheider'
require_relative 'q_learning_entscheider/q_learning_modell'
require_relative 'q_learning_entscheider/bewerter'
require_relative 'q_learning_entscheider/ai_aktions_raum'
require 'ruby-fann'
