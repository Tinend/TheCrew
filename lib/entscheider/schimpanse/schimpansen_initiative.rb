...
module SchimpansenInitiative
  ...
  def plus_initiative
    Karte.alle.count do |karte|
      !@spiel_informations_sicht.ist_gegangen?(karte) && @karte.schlaegt?(karte)
    end * plus_initiative_karten_wert * PLUS_INITIATIVE
  end
  ...
  def minus_initiative
    (Karte.alle - @spiel_informations_sicht.karten).count do |karte|
      !@spiel_informations_sicht.ist_gegangen?(karte) && karte.schlaegt?(@karte)
    end * minus_initiative_karten_wert * MINUS_INITIATIVE
  end
